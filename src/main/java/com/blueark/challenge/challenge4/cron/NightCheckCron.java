...
public class NightCheckCron {
    ...
    @Transactional
    public void checkForWeirdConsumptionDuringNight() {
        log.info("Begin to check the potential unknown consumption during nights of the clients");
        ...
        allUsers.forEach(user -> {
            final SurpriseResponse surpriseResponse = surpriseService.getSurpriseConsumption(user.getUserId(), gregorianCalendar.getTime(), new Date());
